/*
18. Write a program which accept file name which contains information of student and display names 
		of all students whose length of the name is 6.  
...
class Student
{
	...
	static void Display(String filename)
	{
		...
		try
		{
			...
			System.out.print("\n  all students whose length of the name is 6 \n ");
			for(int i=0;i<ali.size();i++)
			{
				if((ali.get(i).getName()).length()==6)
				{
					System.out.print("\n "+ali.get(i).getName());
				}
			}
